-- Answer questions from a potential investor about Maven Movies
...
SELECT 
    ...
    AVG(CASE WHEN actor_award.actor_id IS NULL THEN 0 ELSE 1 END) AS percent_films_in_inventory
FROM actor_award	
GROUP BY
	number_of_awards;
